...
<img src="images/no.png" width="50" height="50"> TWA Support
...
<img src="images/yes.png" width="50" height="50"> TWA Support
...
<img src="images/warning.png" width="50" height="50"> TWA Support - TWA does not exclude voicemail calls, this is currently skewing the numbers.
...
<img src="images/warning.png" width="50" height="50"> TWA Support - Matches the per user count below, not this number.

#### Video Time

The same logic as Audio time, but for the video modality. It does not equal any number in the per user report. 

<img src="images/warning.png" width="50" height="50"> TWA Support - TWA does not include "receive only" minutes, this is currently skewing the numbers.
...
<img src="images/no.png" width="50" height="50"> TWA Support - TWA does not currently collect this metric.
